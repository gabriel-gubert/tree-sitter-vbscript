module.exports = grammar({
  ...
  rules: {
    ...
    invocation_statement: $ => prec.left(seq(
      ...
      optional(seq($._horizontal_whitespace, $.argument_list)
    ))),
    ...
    _expression: $ => choice(
      prec(2,$._right_of_dot_expression),
    ...
    _right_of_dot_expression: $ => choice(
      prec(3,$.attribute_expression),
      prec(2,$.function_call),
      prec(1,$.identifier)
    ),

    attribute_expression: $ =>
      prec.left(3,seq($._expression, token.immediate('.'), $._right_of_dot_expression)),
